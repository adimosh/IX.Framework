...
namespace IX.StandardExtensions
{
    ...
    public static class ArrayStaticMethodExtensions
    {
        ...
        /// index of the last element plus 1).</returns>
        ...
        /// <param name="array">The sorted one-dimensional, zero-based <see cref="Array"/> to search.</param>
        /// <param name="value">The object to search for.</param>
        /// <param name="comparer">The <see cref="IComparer"/> implementation to use when comparing elements.-or- null to use the <see cref="IComparable"/> implementation of each element.</param>
        /// <returns>The index of the specified value in the specified array, if value is found. If
        /// value is not found and value is less than one or more elements in array, a negative
        /// number which is the bitwise complement of the index of the first element that
        /// is larger than value. If value is not found and value is greater than any of
        ...
        /// <param name="array">The one-dimensional, zero-based <see cref="Array"/> to search.</param>
        /// <param name="match">The <see cref="Predicate{T}"/> that defines the conditions of the element to search for.</param>
        /// <returns>An <see cref="Array"/> containing all the elements that match the conditions defined
        /// by the specified predicate, if found; otherwise, an empty <see cref="Array"/>.</returns>
        ...
        /// defined by match, if found; otherwise, –1.</returns>
        public static int FindLastIndex<T>(this T[] array, int startIndex, int count, Predicate<T> match) => Array.FindLastIndex(array, count, match);
        ...
        /// <returns>The index of the first occurrence of value, if it’s found, in the array from
        /// index startIndex to startIndex + count - 1; otherwise, the lower bound of the
        /// array minus 1.</returns>
        ...
        /// <param name="startIndex">The starting index of the search. 0 (zero) is valid in an empty array.</param>
        /// <param name="count">The number of elements to search.</param>
        /// <returns>The zero-based index of the first occurrence of value within the range of elements
        /// in array that starts at startIndex and contains the number of elements specified
        /// in count, if found; otherwise, –1.</returns>
        ...
        /// startIndex, if found; otherwise, –1.</returns>
        ...
        /// bound of the array minus 1.</returns>
        ...
        /// <param name="array">The one-dimensional, zero-based <see cref="Array"/> to search.</param>
        /// <param name="value">The object to locate in array.</param>
        /// <returns>The zero-based index of the last occurrence of value within the entire array,

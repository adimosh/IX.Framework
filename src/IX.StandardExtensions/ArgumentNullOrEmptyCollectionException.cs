...
namespace IX.StandardExtensions
{
    ...
    public class ArgumentNullOrEmptyCollectionException : ArgumentException
    {
        ...
        public ArgumentNullOrEmptyCollectionException(string argumentName)
            : base(string.Format(Resources.ErrorArgumentNullOrEmptyCollection, argumentName), argumentName)
        {
        }
        ...
        public ArgumentNullOrEmptyCollectionException(string argumentName, Exception internalException)
            : base(string.Format(Resources.ErrorArgumentNullOrEmptyCollection, argumentName), argumentName, internalException)
        {
        }
        ...
        protected ArgumentNullOrEmptyCollectionException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
#endif

...
namespace IX.StandardExtensions
{
    ...
    public class ArgumentNotPositiveException : ArgumentException
    {
        ...
        public ArgumentNotPositiveException(string argumentName)
            : base(string.Format(Resources.ErrorArgumentNotPositive, argumentName), argumentName)
        {
        }
        ...
        public ArgumentNotPositiveException(string argumentName, Exception internalException)
            : base(string.Format(Resources.ErrorArgumentNotPositive, argumentName), argumentName, internalException)
        {
        }
        ...
        protected ArgumentNotPositiveException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
#endif

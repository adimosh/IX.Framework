...
namespace IX.StandardExtensions.TestUtils
{
    ...
    public static class Delays
    {
        ...
        public static Task DelayByTenMillisecondsAsync(CancellationToken cancellationToken = default) => Task.Delay(
            10,
            cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A <see cref="Task" /> which can be awaited.</returns>
        public static Task DelayByTenMillisecondsAsync<T>(
            T state,
            CancellationToken cancellationToken = default) => Task.Delay(
            10,
            cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A <see cref="Task" /> which can be awaited.</returns>
        public static Task DelayByOneHundredMillisecondsAsync(CancellationToken cancellationToken = default) =>
            Task.Delay(
                100,
                cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A <see cref="Task" /> which can be awaited.</returns>
        public static Task DelayByOneHundredMillisecondsAsync<T>(
            T state,
            CancellationToken cancellationToken = default) => Task.Delay(
            100,
            cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A <see cref="Task" /> which can be awaited.</returns>
        public static Task DelayByOneThousandMillisecondsAsync(CancellationToken cancellationToken = default) =>
            Task.Delay(
                1000,
                cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A <see cref="Task" /> which can be awaited.</returns>
        public static Task DelayByOneThousandMillisecondsAsync<T>(
            T state,
            CancellationToken cancellationToken = default) => Task.Delay(
            1000,
            cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A <see cref="Task" /> which can be awaited.</returns>
        public static Task DelayByAnAmountAsync(
            int milliseconds,
            CancellationToken cancellationToken = default) => Task.Delay(
            milliseconds,
            cancellationToken);

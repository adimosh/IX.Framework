...
namespace IX.Retry
{
    ...
    public class RetryOptions
    {
        ...
        /// <summary>
        ///     Gets a value indicating whether whether or not to throw an exception at the end of the retrying process, if it is
        ///     unsuccessful.
        /// </summary>
        ...
        /// <summary>
        ///     Gets a list of exceptions and optional conditional methods that will be evaluated when deciding whether or not to
        ///     retry.
        /// </summary>
        /// <returns>A list of exception/delegate tuples.</returns>
        public List<Tuple<Type, Func<Exception, bool>>> RetryOnExceptions { get; } =
            new List<Tuple<Type, Func<Exception, bool>>>();

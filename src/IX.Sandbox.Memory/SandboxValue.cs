...
namespace IX.Sandbox.Memory
{
    ...
    ///     <para>
    ///         When implementing a new kind of sandbox value, please keep in mind that the value lives a single entity, and
    ///         cannot be split (say, when simulating an array).
    ///     </para>
    /// </remarks>

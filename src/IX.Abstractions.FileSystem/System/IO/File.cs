...
namespace IX.System.IO
{
    ...
    public class File : IFile
    {
        ...
        /// <paramref name="path"/> or <paramref name="contents"/> is <see langword="null"/> (<see langword="Nothing"/> in Visual Basic).
        /// </exception>
        /// <remarks>
        /// This operation always requires an encoding to be used. If <paramref name="encoding" /> is set to <see langword="null"/>, an implementation-specific
        ...
        /// <exception cref="T:System.ArgumentNullException">
        /// <paramref name="sourceFileName"/> or <paramref name="destFileName"/> is <see langword="null"/> (<see langword="Nothing"/> in Visual Basic).
        /// </exception>
        ...
        /// <exception cref="T:System.ArgumentNullException">
        /// <paramref name="path"/> or <paramref name="bytes"/> is <see langword="null"/> (<see langword="Nothing"/> in Visual Basic).
        /// </exception>

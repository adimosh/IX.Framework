...
namespace IX.System.IO
{
    ...
    public class Path : IPath
    {
        ...
        /// </remarks>
        public string ChangeExtension(string path, string extension) => FS.Path.ChangeExtension(path, extension);
        ...
        /// <exception cref="FS.PathTooLongException">In the .NET for Windows Store apps or the Portable Class Library, catch the base class exception, <see cref="FS.IOException" />, instead.The path parameter is longer than the system-defined maximum length.</exception>
        ...
        /// <exception cref="FS.PathTooLongException">The specified path, file name, or both exceed the system-defined maximum length. For example, on Windows-based platforms, paths must be less than 248 characters, and file names must be less than 260 characters.</exception>
        ...
        /// <exception cref="FS.IOException">An I/O error occurs, such as no unique temporary file name is available. -or- This method was unable to create a temporary file.</exception>

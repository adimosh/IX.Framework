// <copyright file="AspectDependencyPosition.cs" company="Adrian Mos">
...
namespace IX.Aspects
{
    ...
    {
        /// <summary>
        /// Before the target aspect.
        /// </summary>
        Before = -1,

        /// <summary>
        /// Not ordered, or any order.
        /// </summary>
        Any = 0,

        /// <summary>
        /// After the target aspect.
        /// </summary>
        After = 1,
    }
}
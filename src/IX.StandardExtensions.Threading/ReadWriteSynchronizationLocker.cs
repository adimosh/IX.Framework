...
namespace IX.StandardExtensions.Threading
{
    ...
    public class ReadWriteSynchronizationLocker : SynchronizationLocker
    {
        ...
        /// <exception cref="TimeoutException">The lock could not be acquired in time.</exception>
        public ReadWriteSynchronizationLocker(ReaderWriterLockSlim locker, int lockAcquisitionTimeout)
        ...
        /// <exception cref="TimeoutException">The lock could not be acquired in time.</exception>
        public ReadWriteSynchronizationLocker(ReaderWriterLockSlim locker, double lockAcquisitionTimeoutMilliseconds)
        ...
        /// <exception cref="TimeoutException">The lock could not be acquired in time.</exception>
        public ReadWriteSynchronizationLocker(ReaderWriterLockSlim locker, TimeSpan lockAcquisitionTimespan)
            : base(locker)
        {

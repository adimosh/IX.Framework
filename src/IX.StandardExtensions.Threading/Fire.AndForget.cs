...
#pragma warning restore HeapAnalyzerMethodGroupAllocationRule // Delegate allocation from a method group
                ...
                new Tuple<Func<Task>, Action<Exception>, TaskScheduler, CancellationToken>(action, exceptionHandler, TaskScheduler.FromCurrentSynchronizationContext(), cancellationToken),
                cancellationToken);

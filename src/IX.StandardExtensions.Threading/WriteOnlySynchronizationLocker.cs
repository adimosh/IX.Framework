...
namespace IX.StandardExtensions.Threading
{
    ...
    public class WriteOnlySynchronizationLocker : SynchronizationLocker
    {
        ...
        /// <exception cref="TimeoutException">The lock could not be acquired in time.</exception>
        public WriteOnlySynchronizationLocker(IReaderWriterLock locker, int lockAcquisitionTimeout)
        ...
        /// <exception cref="TimeoutException">The lock could not be acquired in time.</exception>
        public WriteOnlySynchronizationLocker(IReaderWriterLock locker, double lockAcquisitionTimeoutMilliseconds)
        ...
        /// <exception cref="TimeoutException">The lock could not be acquired in time.</exception>
        public WriteOnlySynchronizationLocker(IReaderWriterLock locker, TimeSpan lockAcquisitionTimespan)
            : base(locker)
        {
